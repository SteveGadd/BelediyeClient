...
/**
 * <p>Java class for arrayOfSuAboneBilgisi complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="suAboneBilgisi" type="{http://belediye.turkiye.gov.tr/v3}suAboneBilgisiType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "arrayOfSuAboneBilgisi", propOrder = {
    "suAboneBilgisi"
})
public class ArrayOfSuAboneBilgisi {
     ...
     * This is why there is not a <CODE>set</CODE> method for the suAboneBilgisi property.
     * 
     * <p>
