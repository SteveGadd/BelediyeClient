...
/**
 * <p>Java class for arrayOfGunlukFaaliyet complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="faaliyetBilgisi" type="{http://belediye.turkiye.gov.tr/v3}gunlukFaaliyetType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "arrayOfGunlukFaaliyet", propOrder = {
    "faaliyetBilgisi"
})
public class ArrayOfGunlukFaaliyet {
     ...
     * This is why there is not a <CODE>set</CODE> method for the faaliyetBilgisi property.
     * 
     * <p>
