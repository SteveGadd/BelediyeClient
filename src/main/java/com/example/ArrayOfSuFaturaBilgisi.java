...
/**
 * <p>Java class for arrayOfSuFaturaBilgisi complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="suFaturaBilgisi" type="{http://belediye.turkiye.gov.tr/v3}suFaturaBilgisiType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "arrayOfSuFaturaBilgisi", propOrder = {
    "suFaturaBilgisi"
})
public class ArrayOfSuFaturaBilgisi {
     ...
     * This is why there is not a <CODE>set</CODE> method for the suFaturaBilgisi property.
     * 
     * <p>
